...
Additional velocity channels can be defined in `twist_mux\.yaml <https://github.com/husky/husky/blob/noetic-devel/husky_control/config/twist_mux.yaml>`_, or can be piped into the lowest-priority cmd_vel topic.
...
Additional odometry information sources can be added to the EKF in `localization\.yaml <https://github.com/husky/husky/blob/noetic-devel/husky_control/config/twist_mux.yaml>`_.
